...
public class MyData : BaseViewModel, IMyData
{
    ...
    public byte[] Icon => SvgCache.GetSvgFromEmbeddedResource("boards");
...
public class MyGroup : BaseViewModel, IMyData
{
    ...
    public byte[] ExpandIndicatorSvg
    {
        get => IsExpanded
            ? SvgCache.GetSvgFromEmbeddedResource("arrow_down")
            : SvgCache.GetSvgFromEmbeddedResource("arrow_right");
    }

    public byte[] SvgResIcon
    {
        get
        {
            // if (ResTyp == ResourceType.Mitarbeiter)
            //     return SvgMA;
            // else if (ResTyp == ResourceType.Geraet)
            //     return SvgGER;
            // else
            //     return null;
            return SvgMA;
    ...
    // private byte[] SvgMA => IsRunning
    //         ? this.CurrentTheme.GetSvg(BaseTheme.IconTyp.RessourceMALaufend)
    //         : this.CurrentTheme.GetSvg(BaseTheme.IconTyp.RessourceMA);
    private byte[] SvgMA => SvgCache.GetSvgFromEmbeddedResource("boards");
